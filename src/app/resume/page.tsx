...
export default function page() {
  return (
    <>
      <h1 className="phone:text-start mb-4 flex items-center text-3xl font-bold text-primary ombraxs md:text-4xl">
      ...
      <div>
        <div className="relative my-20 flex flex-col space-y-10 space-x-10 md:flex-row md:space-y-0">
          <p className="w-30 text-sm ">Ottobre 2023 a oggi</p>
          <div>
        ...
        <div className="relative my-20 flex flex-col space-y-10 space-x-10 md:flex-row md:space-y-0">
          <p className="phone:w-full w-fit text-sm ">
            11/2022 - 07/2023
          </p>
          <div>
            <h5 className="text-lg font-bold text-primary ombraxs">
