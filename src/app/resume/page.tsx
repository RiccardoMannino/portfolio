    ...
    <>
      ...
      <div className="text-lg max-sm:text-center max-sm:text-base">
        <div className="relative my-20 flex flex-col space-y-10 space-x-10 md:flex-row md:space-y-0">
          <p className="text-foreground w-30 font-semibold max-sm:w-full">
            Ottobre 2023 a oggi
          </p>
          <div className="text-foreground">
            <h5 className="text-primary ombraxs font-bold">
              Freelance da Remoto
            </h5>
            <p className="font-semibold">Sviluppatore Web (junior).</p>
        ...
        <div className="text-foreground relative my-20 flex flex-col space-y-10 space-x-10 md:flex-row md:space-y-0">
          <p className="phone:w-full w-fit font-semibold">11/2022 - 07/2023</p>
          <div>
            <h5 className="text-primary ombraxs font-bold">
        ...
        <div className="text-foreground relative my-20 flex flex-col space-y-10 space-x-10 md:flex-row md:space-y-0">
          <p className="phone:w-full w-fit font-semibold">04/2022 - 10/2022</p>
          <div>
            <h5 className="text-primary ombraxs font-bold">
              DevelHope S.R.L Palermo, Italia
            </h5>
            <p className="font-semibold">Corso intensivo Web Developer</p>
            <div className="my-2 flex items-center space-x-1">
              <IconCircleCheckFilled className="text-primary h-4 w-8 sm:w-4" />
              <span className="font-semibold">
        ...
        <div className="text-foreground relative my-20 flex flex-col space-y-10 space-x-10 md:flex-row md:space-y-0">
          <p className="phone:w-full w-fit font-semibold">10/2020 - 03/2022</p>
          <div className="w-full">
            <h5 className="text-primary ombraxs font-bold">
              Forneria Messina di Messina G.& C. SNC, Monreale, Italia
            </h5>
            <p className="font-semibold">Assistente Sito Web (Freelance)</p>
            <div className="my-2 flex items-center space-x-1">
              <IconCircleCheckFilled className="text-primary h-4 w-8 sm:w-4" />
              <span className="font-semibold">
